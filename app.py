...
def root_route():
    # আগের সম্পূর্ণ গাইডলাইন ফিরিয়ে আনা হলো
    return jsonify({
        "Developer": "Riduanul Islam",
        ...
        "API_Usage_Guide": {
            "Main_Endpoint": "/api/wishlist",
            "1_Token_Options_Choose_Any_One": [
                "?uid=YOUR_UID&password=YOUR_PASS",
                "?access_token=YOUR_TOKEN",
                "?eat_token=YOUR_TOKEN",
                "?jwt_token=YOUR_TOKEN"
            ],
            "2_Items_Options_Choose_Any_One": [
                "For ALL Default Items : Don't use 'items' parameter",
                "For SINGLE Item       : Add '&items=101000001'",
                "For MULTIPLE Items    : Add '&items=101000001,102000014'"
            ],
            "Examples": {
                "Default_Items_Using_UID": "/api/wishlist?uid=XXX&password=XXX",
                "ALL_Default_Items_Using_Token": "/api/wishlist?access_token=XXX",
                "SINGLE_Item_Using_UID": "/api/wishlist?uid=XXX&password=XXX&items=101000001",
                "MULTIPLE_Items_Using_Token": "/api/wishlist?access_token=XXX&items=101000001,102000014,203000001"
            }
        }
    })
...
def wishlist_manager():
    ...
    if jwt_token:
        ...
        # প্যারামিটার মিসিং হলে গাইডলাইন দেখানোর অপশন ফিরিয়ে আনা হলো
        error_response.update({
            'status': 'error',
            'message': 'Missing authentication parameters. Please check the API Usage Guide below.',
            'API_Usage_Guide': {
                ...
                'Examples': [
                    '/api/wishlist?uid=12345678&password=my_password',
                    '/api/wishlist?access_token=YOUR_ACCESS_TOKEN_HERE&items=101000001',
                    '/api/wishlist?eat_token=YOUR_EAT_TOKEN_HERE&items=101000001,102000014'
                ]
            }
        })
        return jsonify(error_response), 400
    ...
    # আপনার চাওয়া অনুযায়ী একদম সঠিক সিরিয়ালে রেসপন্স
    final_response = {
        "Developer": "Riduanul Islam",
        "TelegramBot": "https://t.me/RiduanFFBot",
        "TelegramChannel": "https://t.me/RiduanOfficialBD",
